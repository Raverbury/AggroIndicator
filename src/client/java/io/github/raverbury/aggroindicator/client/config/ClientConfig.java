package io.github.raverbury.aggroindicator.client.config;
...
public class ClientConfig {
    ...
    private static final File CONFIG_FILE =
            new File(FabricLoader.getInstance().getConfigDir().toFile(),
                    AggroIndicator.MOD_ID + "-client.json");
    ...
    public boolean scaleWithMobSize = false;
    ...
    public static ClientConfig loadOrDefault() {
        ...
        try (Reader reader = Files.newBufferedReader(CONFIG_FILE.toPath())) {
            ...
            AggroIndicator.LOGGER.error("[Aggro Indicator] Loading config " +
                            "failed: {}," +
                            " using default value.",
                    e.getMessage(), e);
