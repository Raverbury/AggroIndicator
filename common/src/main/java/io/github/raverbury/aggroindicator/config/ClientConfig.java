...
public class ClientConfig {
    ...
    public String alertIconStyleComment = "# A value between 0 and 2 (inclusive). Icon styles in corresponding order: Classic, MGS and Block Bench. Can be replaced with a resource pack.";
    ...
    public static ClientConfig loadOrDefault() {
        ...
        cachedAlertColorRGB[0] = alertColor.getRed() / 255f;
    ...
    public float[] getAlertColorRGB() {
        return cachedAlertColorRGB;
    }
