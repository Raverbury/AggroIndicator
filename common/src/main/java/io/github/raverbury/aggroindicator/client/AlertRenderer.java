...
public final class AlertRenderer {
    ...
    private static ResourceLocation aggroIconResourceLocation = getConfiguredAggroIcon(0);
    ...
    public static void setAggroIcon(int aggroIconIndex) {
        aggroIconResourceLocation = getConfiguredAggroIcon(aggroIconIndex);
    }
    ...
    public static void renderAlertIconForEntity(Entity entity, float partialTick, PoseStack matrix, MultiBufferSource multiBufferSource, Camera camera) {
        ...
        VertexConsumer vertexConsumer = multiBufferSource.getBuffer(RenderType.text(aggroIconResourceLocation));
